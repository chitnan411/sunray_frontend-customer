...
const Wishlist = ({location, cartItems, currency, addToCart, wishlistItems, deleteFromWishlist, deleteAllFromWishlist}) => {
  ...
  return (
      <Fragment>
        <MetaTags>
          <title>Wishlist | sunraystationers.com</title>
          <meta
              name="description"
              ...
              {wishlistItems && wishlistItems.length >= 1 ? (
                  <Fragment>
                    <h3 className="cart-page-title">
                      <strong>My Wishlist</strong> {wishlistItems.length} {wishlistItems && wishlistItems.length === 1 ? "item" : "items"}
                    </h3>
                    <div className="row">
                              ...
                              return (
                                  <tr key={key}>
                                    <td className="product-thumbnail">
                                      ...
                                      >
                                        {(wishlistItem.productImages && wishlistItem.productImages.length > 1 )
                                            ?
                                            <img
                                                className="img-fluid"
                                                src={wishlistItem.productImages[0].original}
                                                alt={wishlistItem.productImages[0].fileName}/>
                                            :
                                            <img
                                                className="img-fluid"
                                    ...
                                    <td className="product-name text-center">
                                      ...
                                      >
                                        {wishlistItem.productName || wishlistItem.comboName}
                                      </Link>
                                    </td>
...
const mapDispatchToProps = dispatch => {
  return {
    ...
    deleteAllFromWishlist: addToast => {dispatch(deleteAllFromWishlist(addToast));}
  };
};
