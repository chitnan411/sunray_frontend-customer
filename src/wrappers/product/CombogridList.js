...
const ComboGrid = ({products, currency, addToCart, addToWishlist, addToCompare, cartItems, wishlistItems, compareItems, sliderClassName, spaceBottomClass}) => {
  return (
    <Fragment>
...
export default connect(mapStateToProps, mapDispatchToProps)(ComboGrid);
