...
import {getProducts, getSortedProducts} from "../../helpers/product";
import ProductGridSingle from "../../components/product/ProductGridSingle";
import { addToCart } from "../../redux/actions/cartActions";
import { addToWishlist } from "../../redux/actions/wishlistActions";
import { addToCompare } from "../../redux/actions/compareActions";

const ProductGrid = ({products, currency, addToWishlist, addToCompare, cartItems, wishlistItems, compareItems, sliderClassName, spaceBottomClass}) => {
  return (
    <Fragment>
...
const mapStateToProps = (state, ownProps) => {
  return {
    products: getSortedProducts(state.products,ownProps.category, ownProps.type, ownProps.limit),
