...
const SSHomeFeaturedProductsTab = ({ spaceTopClass, spaceBottomClass, bgColorClass, category, sectionTitle }) => {
  ...
  SSHomeFeaturedProductsTab.propTypes = {
  ...
  export default SSHomeFeaturedProductsTab;
